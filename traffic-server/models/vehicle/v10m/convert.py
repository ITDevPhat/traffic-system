...
model_path = r"D:\ITDevPhat\Python\LVTN\traffic-system\traffic-server\models\vehicle\v10m\yolo_vehicle_v10m.pt"

# --- Thư mục đích để lưu file .onnx ---
export_dir = os.path.dirname(model_path)

print("🔄 Đang load model YOLOv10m...")
model = YOLO(model_path)

# --- Xuất sang ONNX (FP32, opset 11) ---
print("⚙️  Đang export sang ONNX FP32 (opset=11)...")
export_path = os.path.join(export_dir, "yolo_vehicle_v10m.onnx")
