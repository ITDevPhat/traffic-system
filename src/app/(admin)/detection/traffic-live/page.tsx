...
export default function TrafficLivePage() {
  ...
  return (
    <>
      <PageTitle title="Traffic Light Live Detection" subName="Detection" />
            ...
            <Card>
              <Card.Body>
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <h4 className="mb-0">🚦 Phát Hiện Đèn Giao Thông Realtime</h4>
                ...
                {!videoSrc && (
                  <Alert variant="info">
                    ...
                    Vui lòng chọn video để bắt đầu. Sau đó vẽ vùng ROI cho đèn giao thông.
                  </Alert>
                )}
