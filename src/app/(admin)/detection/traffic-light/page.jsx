...
function DetectionPageBinaryContent() {
  ...
  const overlayRois = useMemo(() => {
    if (!videoReady || !isDetectionRunning) return [];
  ...
  }, [isDetectionRunning, roiPolygons, videoReady, violationRegionNormalized]);
  ...
  useEffect(() => {
    if (videoReady && videoSize && isDetectionRunning) {
      fetchViolationRegion();
    }
  }, [fetchViolationRegion, isDetectionRunning, videoReady, videoSize]);
      ...
      <div className="container-fluid mt-3">
        ...
        <div style={{
          ...
          <RoiOverlay
            ...
            visible={videoReady && isDetectionRunning}
          />
