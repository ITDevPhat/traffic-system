...
// Dynamic import ApexCharts để giảm bundle size
const ReactApexChart = dynamic(() => import('react-apexcharts'), { 
  ssr: false,
  loading: () => <div className="d-flex justify-content-center py-5"><div className="spinner-border text-primary" role="status"></div></div>
});
const SalesChart = () => {
  return <Col xl={8}>
